...
Keep responses brief (2-4 sentences usually) unless the user asks for detailed analysis.`;
  ...
  // TEST: Generate sample notifications for testing
  app.post("/api/notifications/test", isAuthenticated, async (req: any, res) => {
    try {
      ...
      const testNotifications = [
        {
          ...
          type: "friend_request",
          title: "New Friend Request",
          message: "Alex Johnson wants to be your friend! Check your pending requests.",
          read: false,
          actorId: userId,
          resourceId: "test-friend-1",
          resourceType: "friendship",
        },
        {
          userId,
          type: "friend_accepted",
          title: "Friend Request Accepted",
          message: "Sarah Miller accepted your friend request. You can now see each other's progress!",
          read: false,
          actorId: userId,
          resourceId: "test-friend-2",
          resourceType: "friendship",
        },
        {
          userId,
          ...
          message: "Mike Chen liked your post: 'Just hit a new personal record today!'",
          read: false,
          actorId: userId,
        ...
        },
        {
          ...
          type: "post_comment",
          title: "New Comment",
          message: "Emma Davis commented on your post: 'Amazing progress, keep it up!'",
          read: false,
          actorId: userId,
          resourceId: "test-post-2",
          resourceType: "post",
        },
        {
          userId,
          type: "instant_message",
          title: "New Message",
          message: "Chris Brown: 'Hey! Want to join our workout challenge this week?'",
          read: false,
          actorId: userId,
          resourceId: "test-dm-1",
        ...
        },
        {
          ...
          message: "Jordan Lee challenged you to a 7-day step challenge!",
          read: false,
          actorId: userId,
          resourceId: "test-competition-1",
        ...
        },
        {
          ...
          message: "Don't forget to complete your daily meditation task!",
          read: false,
          actorId: null,
          resourceId: "test-task-1",
          resourceType: "task",
        },
      ];
      ...
      for (const notification of testNotifications) {
        const n = await storage.createNotification(notification as any);
        created.push(n);
      }

      res.json({ message: `Created ${created.length} test notifications`, notifications: created });
    } catch (error) {
